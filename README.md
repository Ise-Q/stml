...
│   ├── macro_features_engineered.*    standalone F11 macro dataset (generated)
...
`data/features/`, the standalone `data/macro_features_engineered.{parquet,csv}`
F11 dataset, the `results/feature_redundancy.{json,csv}` map, the
